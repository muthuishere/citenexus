...
(``pip install citenexus[postgres]``), imported lazily at first connection —
            ...
            if self._connect is not None:
                ...
                try:
                    ...
                    raise ImportError(
                        ...
                        "pip install 'citenexus[postgres]'"
                    ) from error
...
class PostgresTextSearch:
    ...
    wire the text seam explicitly, e.g. ``CiteNexus(text_search=...)``.)
    """
