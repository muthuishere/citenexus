...
- [ ] 1.2 Implement `src/citenexus/storage/paths.py`.
...
- [ ] 2.2 Implement `src/citenexus/storage/backend.py` (`StorageBackend`,
...
- [ ] 3.2 Implement `src/citenexus/storage/lance_store.py`.
...
- [ ] 4.2 Implement `src/citenexus/storage/manifest.py`.
...
- [ ] 6.1 Scoped: `uv run pytest tests/storage -m "not integration"`, `ruff`,
      `mypy` on `src/citenexus/storage tests/storage` — all green.
