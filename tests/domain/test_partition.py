...
def test_variable_depth_paths() -> None:
    p3 = PartitionPath.of(("org", "acme"), ("product_line", "contracts"), ("product", "nda-review"))
...
def test_is_prefix_of() -> None:
    a = PartitionPath.of(("org", "acme"), ("product_line", "contracts"))
    b = PartitionPath.of(("org", "acme"), ("product_line", "contracts"), ("product", "nda-review"))
...
def test_divergent_path_is_not_a_prefix() -> None:
    ...
    b = PartitionPath.of(("org", "acme"), ("product_line", "contracts"), ("product", "nda"))
